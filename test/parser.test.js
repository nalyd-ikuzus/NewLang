...
const syntaxChecks = [
  ...
  ["function with one param", "newfunction f (x : int) : void {}"],
  ["function with two params", "newfunction f (x : int, y : int) : void {}"],
  ...
  ["arithmetic", "confess 2 multiply x plus 3 divide 5 minus -1 remain 7 exp 3 exp 3"],
...
const syntaxErrors = [
  ...
  ["function with no return type", "newfunction f() {}", /Line 1, col 17:/],
  ...
  ["associating relational operators", "speak(1 < 2 < 3)", /Line 1, col 9:/],
  ["if as identifier", "newnum if is 8", /Line 1, col 8/],
  ["unbalanced brackets", "newfunction f () : void {", /Line 1, col 26/],
